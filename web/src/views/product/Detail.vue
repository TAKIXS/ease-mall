...
<template>
  <div v-if="product.id" class="detail-wrap">
    ...
    <div class="info-col">
      ...
      <div class="meta-row"><span>📦 库存 {{ product.stock }}</span><span>📈 已售 {{ product.sales }}</span></div>
...
.btn-cart { padding: 14px 32px; border: 2px solid var(--brown); background: transparent; color: var(--brown); border-radius: 14px; font-size: 16px; font-weight: 600; font-family: inherit; cursor: pointer; transition: all .2s; }
